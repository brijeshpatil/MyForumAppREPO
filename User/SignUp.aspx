<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="MyForumApp.User.SignUp" %>
            ...
            <div class="container">
                ...
                <div class="col-md-8 login-form-w3-agile">
                    ...
                    <div class="w3_form_body_grid">
                        ...
                        <asp:DropDownList ID="drpTechnologies" runat="server" CssClass="frm-field required"></asp:DropDownList>
                    </div>
                    <div class="w3_form_body_grid">
                        <span>Name</span>
                    ...
                    <div class="w3_form_body_grid">
                        <span>GENDER</span>
                        <asp:DropDownList ID="drpGender" runat="server" CssClass="frm-field required">
                    ...
                    <div class="w3_form_body_grid w3_form_body_grid1">
                        ...
                        <asp:TextBox ID="txtDBO" runat="server" TextMode="Date"></asp:TextBox>
